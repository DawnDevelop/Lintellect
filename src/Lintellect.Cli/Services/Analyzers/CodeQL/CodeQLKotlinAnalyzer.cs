...
internal class CodeQLKotlinAnalyzer : CodeQLAnalyzerBase
{
    public override EProgrammingLanguage Language => EProgrammingLanguage.Kotlin;
    ...
    protected override async Task<string> GenerateCodeQLDatabaseAsync(string solutionPath)
    {
        ...
        var (success, _, error) = await CodeQLExtensions.ExecuteGitHubCliCommandAsync(
