...
/// </summary>
/// <param name="Identifier">The unique identifier for the Git context (e.g., PR number, build ID, branch name)</param>
...
public record GitInfo(string Identifier, string CommitId, string RepositoryName, EGitInfoType Type = EGitInfoType.Unknown, string? ProjectName = null);