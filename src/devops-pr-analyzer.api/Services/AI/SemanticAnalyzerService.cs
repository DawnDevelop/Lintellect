...
using devops_pr_analyzer.Services.AI.Prompts;
...
public sealed class SemanticAnalyzerService(SemanticAnalyzerOptions options) : IAnalyzerService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var systemPrompt = _templateService.RenderTemplate("SummarySystemPrompt");
        var chatHistory = new ChatHistory(systemPrompt);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var gitProvider = analysisResult.AnalysisResult.GitProvider switch
        {
            EGitProvider.AzureDevops => "Azure DevOps",
            EGitProvider.GitHub => "GitHub",
            _ => "Azure DevOps"
        };
