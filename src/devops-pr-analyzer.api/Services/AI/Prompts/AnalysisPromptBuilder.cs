...
internal sealed class AnalysisPromptBuilder
{
    ...
    /// </summary>
    public string BuildAnalysisPrompt(AnalysisResult analysisResult, Dictionary<string, string> diffs)
    {
        var sections = new[]
        {
            BuildHeader(),
    ...
    /// </summary>
    public string BuildInlineSuggestionsPrompt(AnalysisResult analysisResult, Dictionary<string, string> diffs)
    {
        var sections = new[]
        {
    ...
    /// </summary>
    public string BuildSummaryPrompt(AnalysisResult analysisResult, Dictionary<string, string> diffs)
    {
        ...
        {
            builder.AppendLine($"**PR**: #{analysisResult.GitInfo.Identifier} in {analysisResult.GitInfo.RepositoryName}");
        }
    ...
    private static string BuildStaticAnalysisSection(AnalysisResult analysisResult)
    {
        var builder = new StringBuilder();
    ...
    private static string BuildStaticAnalyzerFindingsSection(AnalysisResult analysisResult)
    {
